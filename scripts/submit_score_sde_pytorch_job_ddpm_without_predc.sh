...
sbatch --job-name=score_sde_hessian \
        ...
        --wrap="singularity exec --nv --overlay $SCRATCH/singularity/overlay-25GB-500K-DiffusionPreconditioner.ext3:ro /scratch/work/public/singularity/cuda11.6.124-cudnn8.4.0.27-devel-ubuntu20.04.4.sif /bin/bash -c 'source /ext3/env.sh; conda activate base; cd /scratch/yk2516/repos/diffusion_model/second-diffusion/score_sde_pytorch; python main.py --config /scratch/yk2516/repos/diffusion_model/second-diffusion/score_sde_pytorch/configs/vp/ddpm/cifar10_accelerated_sampling.py --eval_folder eval --mode sampling --use_pre_con False --workdir /scratch/yk2516/repos/diffusion_model/second-diffusion/score_sde_pytorch/work_dir'"
